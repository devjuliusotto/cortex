...
export function OfficeAgent({ agent, showWorkspaceLabel, onSelect, onOpen }: { agent: OfficeAgentModel; showWorkspaceLabel: boolean; onSelect: (id: string) => void; onOpen: () => void }) {
